...
.field private static final ai:Landroid/support/v4/view/dp;
...
.field private R:Landroid/support/v4/widget/s;
...
.field private ab:Landroid/support/v4/view/dl;

.field private ac:Landroid/support/v4/view/dl;

.field private ad:Landroid/support/v4/view/dk;

.field private ae:Landroid/support/v4/view/dm;
...
.field private final f:Landroid/support/v4/view/dh;

.field private final g:Landroid/graphics/Rect;

.field private h:Landroid/support/v4/view/bn;
...
.field private o:Landroid/support/v4/view/dn;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/support/v4/view/ViewPager;->ai:Landroid/support/v4/view/dp;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, Landroid/support/v4/view/ViewPager;->f:Landroid/support/v4/view/dh;
    ...
    invoke-direct {v0, p0}, Landroid/support/v4/view/de;-><init>(Landroid/support/v4/view/ViewPager;)V
...
.method private a(IFII)I
    ...
    check-cast v0, Landroid/support/v4/view/dh;
    ...
    check-cast v1, Landroid/support/v4/view/dh;

    .line 2333
    iget v0, v0, Landroid/support/v4/view/dh;->b:I

    iget v1, v1, Landroid/support/v4/view/dh;->b:I
...
.method static synthetic a(Landroid/support/v4/view/ViewPager;)Landroid/support/v4/view/bn;
    .locals 1

    .prologue
    .line 91
    iget-object v0, p0, Landroid/support/v4/view/ViewPager;->h:Landroid/support/v4/view/bn;
...
.method private a(IIII)V
    ...
    invoke-virtual {p0, v0}, Landroid/support/v4/view/ViewPager;->b(I)Landroid/support/v4/view/dh;
    ...
    iget v0, v0, Landroid/support/v4/view/dh;->e:F
...
.method private a(IZIZ)V
    ...
    .line 615
    invoke-virtual {p0, p1}, Landroid/support/v4/view/ViewPager;->b(I)Landroid/support/v4/view/dh;
...
.method private a(Landroid/support/v4/view/dh;ILandroid/support/v4/view/dh;)V
    .locals 11
    ...
    invoke-virtual {v0}, Landroid/support/v4/view/bn;->b()I
    ...
    .line 1236
    iget v0, p3, Landroid/support/v4/view/dh;->b:I

    .line 1238
    iget v1, p1, Landroid/support/v4/view/dh;->b:I

    if-ge v0, v1, :cond_3

    .line 1241
    iget v1, p3, Landroid/support/v4/view/dh;->e:F

    iget v2, p3, Landroid/support/v4/view/dh;->d:F
    ...
    .line 1245
    :goto_2
    iget v5, v0, Landroid/support/v4/view/dh;->b:I
    ...
    .line 1252
    iget-object v5, p0, Landroid/support/v4/view/ViewPager;->h:Landroid/support/v4/view/bn;

    invoke-virtual {v5, v2}, Landroid/support/v4/view/bn;->b(I)F
    ...
    .line 1255
    :cond_2
    iput v3, v0, Landroid/support/v4/view/dh;->e:F

    .line 1256
    iget v0, v0, Landroid/support/v4/view/dh;->d:F
    ...
    .line 1261
    iget v3, p3, Landroid/support/v4/view/dh;->e:F
    ...
    .line 1275
    :cond_5
    iget v5, v0, Landroid/support/v4/view/dh;->d:F
    ...
    .line 1283
    iget v2, p1, Landroid/support/v4/view/dh;->e:F
    ...
    iget v0, p1, Landroid/support/v4/view/dh;->e:F
    ...
    iget v3, p1, Landroid/support/v4/view/dh;->d:F
    ...
    .line 1291
    :goto_a
    iget v2, v0, Landroid/support/v4/view/dh;->b:I

    if-le v1, v2, :cond_9

    .line 1292
    iget-object v9, p0, Landroid/support/v4/view/ViewPager;->h:Landroid/support/v4/view/bn;

    add-int/lit8 v2, v1, -0x1

    invoke-virtual {v9, v1}, Landroid/support/v4/view/bn;->b(I)F
    ...
    .line 1294
    :cond_9
    iget v2, v0, Landroid/support/v4/view/dh;->d:F
    ...
    .line 1295
    iput v2, v0, Landroid/support/v4/view/dh;->e:F
    ...
    iget v1, p1, Landroid/support/v4/view/dh;->d:F
...
.method private a(Z)V
    ...
    .line 1916
    iget-boolean v5, v0, Landroid/support/v4/view/dh;->c:Z

    if-eqz v5, :cond_2

    .line 1918
    iput-boolean v2, v0, Landroid/support/v4/view/dh;->c:Z
...
.method private b(IFI)V
    ...
    .prologue
    .line 1843
    iget-object v0, p0, Landroid/support/v4/view/ViewPager;->ab:Landroid/support/v4/view/dl;
    ...
    invoke-interface {v0, p1, p2, p3}, Landroid/support/v4/view/dl;->a(IFI)V
    ...
    .line 1854
    :cond_2
    iget-object v0, p0, Landroid/support/v4/view/ViewPager;->ac:Landroid/support/v4/view/dl;
...
.method private b(F)Z
    ...
    .line 2243
    iget v8, v0, Landroid/support/v4/view/dh;->b:I
    ...
    .line 2247
    :goto_0
    iget v8, v1, Landroid/support/v4/view/dh;->b:I

    iget-object v9, p0, Landroid/support/v4/view/ViewPager;->h:Landroid/support/v4/view/bn;

    invoke-virtual {v9}, Landroid/support/v4/view/bn;->b()I
    ...
    .line 2249
    iget v1, v1, Landroid/support/v4/view/dh;->e:F
    ...
    .line 2255
    iget-object v1, p0, Landroid/support/v4/view/ViewPager;->R:Landroid/support/v4/widget/s;
    ...
    invoke-virtual {v1, v0}, Landroid/support/v4/widget/s;->a(F)Z
    ...
    .line 2261
    iget-object v2, p0, Landroid/support/v4/view/ViewPager;->S:Landroid/support/v4/widget/s;
    ...
    invoke-virtual {v2, v0}, Landroid/support/v4/widget/s;->a(F)Z
...
.method private d(I)Z
    ...
    .line 1752
    :cond_2
    invoke-direct {p0}, Landroid/support/v4/view/ViewPager;->j()Landroid/support/v4/view/dh;
    ...
    .line 1756
    iget v5, v1, Landroid/support/v4/view/dh;->b:I
    ...
    iget v6, v1, Landroid/support/v4/view/dh;->e:F

    sub-float/2addr v2, v6

    iget v1, v1, Landroid/support/v4/view/dh;->d:F
...
.method private e(I)V
    ...
    invoke-interface {v0, p1}, Landroid/support/v4/view/dl;->a(I)V
...
.method private f(I)V
    ...
    invoke-interface {v0, p1}, Landroid/support/v4/view/dl;->b(I)V
...
.method private g()V
    ...
    .line 518
    iget-boolean v0, v0, Landroid/support/v4/view/di;->a:Z
...
.method private h()V
    ...
    sget-object v1, Landroid/support/v4/view/ViewPager;->ai:Landroid/support/v4/view/dp;
...
.method private i()Z
    ...
    .line 2215
    iget-object v0, p0, Landroid/support/v4/view/ViewPager;->R:Landroid/support/v4/widget/s;

    invoke-virtual {v0}, Landroid/support/v4/widget/s;->c()Z

    move-result v0

    iget-object v1, p0, Landroid/support/v4/view/ViewPager;->S:Landroid/support/v4/widget/s;
...
.method private j()Landroid/support/v4/view/dh;
    .locals 13
    ...
    iget v10, v0, Landroid/support/v4/view/dh;->b:I
    ...
    .line 2292
    iget-object v0, p0, Landroid/support/v4/view/ViewPager;->f:Landroid/support/v4/view/dh;
    ...
    iput v6, v0, Landroid/support/v4/view/dh;->e:F

    .line 2294
    add-int/lit8 v6, v8, 0x1

    iput v6, v0, Landroid/support/v4/view/dh;->b:I

    .line 2295
    iget-object v6, p0, Landroid/support/v4/view/ViewPager;->h:Landroid/support/v4/view/bn;

    iget v7, v0, Landroid/support/v4/view/dh;->b:I

    invoke-virtual {v6, v7}, Landroid/support/v4/view/bn;->b(I)F

    move-result v6

    iput v6, v0, Landroid/support/v4/view/dh;->d:F
    ...
    .line 2298
    :goto_3
    iget v6, v2, Landroid/support/v4/view/dh;->e:F

    .line 2301
    iget v7, v2, Landroid/support/v4/view/dh;->d:F
    ...
    .line 2310
    :cond_5
    iget v5, v2, Landroid/support/v4/view/dh;->b:I

    .line 2312
    iget v4, v2, Landroid/support/v4/view/dh;->d:F
...
.method private setScrollState(I)V
    ...
    .line 456
    iget-object v0, p0, Landroid/support/v4/view/ViewPager;->ae:Landroid/support/v4/view/dm;
...
.method a(II)Landroid/support/v4/view/dh;
    .locals 2
    ...
    .line 942
    iput p1, v0, Landroid/support/v4/view/dh;->b:I

    .line 943
    iget-object v1, p0, Landroid/support/v4/view/ViewPager;->h:Landroid/support/v4/view/bn;

    invoke-virtual {v1, p0, p1}, Landroid/support/v4/view/bn;->a(Landroid/view/ViewGroup;I)Ljava/lang/Object;

    move-result-object v1

    iput-object v1, v0, Landroid/support/v4/view/dh;->a:Ljava/lang/Object;

    .line 944
    iget-object v1, p0, Landroid/support/v4/view/ViewPager;->h:Landroid/support/v4/view/bn;

    invoke-virtual {v1, p1}, Landroid/support/v4/view/bn;->b(I)F

    move-result v1

    iput v1, v0, Landroid/support/v4/view/dh;->d:F
...
.method a(Landroid/view/View;)Landroid/support/v4/view/dh;
    .locals 4
    ...
    .line 1437
    iget-object v2, p0, Landroid/support/v4/view/ViewPager;->h:Landroid/support/v4/view/bn;

    iget-object v3, v0, Landroid/support/v4/view/dh;->a:Ljava/lang/Object;

    invoke-virtual {v2, p1, v3}, Landroid/support/v4/view/bn;->a(Landroid/view/View;Ljava/lang/Object;)Z
...
.method a()V
    ...
    .line 372
    invoke-static {v1}, Landroid/support/v4/view/cu;->a(Landroid/view/ViewConfiguration;)I
    ...
    iput-object v1, p0, Landroid/support/v4/view/ViewPager;->R:Landroid/support/v4/widget/s;
    ...
    iput-object v1, p0, Landroid/support/v4/view/ViewPager;->S:Landroid/support/v4/widget/s;
    ...
    invoke-direct {v0, p0}, Landroid/support/v4/view/dj;-><init>(Landroid/support/v4/view/ViewPager;)V
    ...
    .line 386
    invoke-static {p0, v4}, Landroid/support/v4/view/bv;->c(Landroid/view/View;I)V
    ...
    invoke-static {p0, v0}, Landroid/support/v4/view/bv;->a(Landroid/view/View;Landroid/support/v4/view/bm;)V
...
.method a(I)V
    ...
    invoke-virtual {v0, v2}, Landroid/support/v4/view/ViewPager;->b(I)Landroid/support/v4/view/dh;
    ...
    iget-object v2, v0, Landroid/support/v4/view/ViewPager;->h:Landroid/support/v4/view/bn;
    ...
    invoke-virtual {v2, v0}, Landroid/support/v4/view/bn;->a(Landroid/view/ViewGroup;)V
    ...
    iget-object v4, v0, Landroid/support/v4/view/ViewPager;->h:Landroid/support/v4/view/bn;

    invoke-virtual {v4}, Landroid/support/v4/view/bn;->b()I
    ...
    check-cast v2, Landroid/support/v4/view/dh;

    .line 1084
    iget v6, v2, Landroid/support/v4/view/dh;->b:I
    ...
    invoke-virtual {v0, v2, v4}, Landroid/support/v4/view/ViewPager;->a(II)Landroid/support/v4/view/dh;
    ...
    .line 1132
    :cond_4
    iget v5, v9, Landroid/support/v4/view/dh;->d:F
    ...
    invoke-direct {v0, v9, v7, v3}, Landroid/support/v4/view/ViewPager;->a(Landroid/support/v4/view/dh;ILandroid/support/v4/view/dh;)V

    .line 1175
    :cond_6
    move-object/from16 v0, p0

    iget-object v3, v0, Landroid/support/v4/view/ViewPager;->h:Landroid/support/v4/view/bn;
    ...
    iget-object v2, v9, Landroid/support/v4/view/dh;->a:Ljava/lang/Object;

    :goto_c
    move-object/from16 v0, p0

    invoke-virtual {v3, v0, v4, v2}, Landroid/support/v4/view/bn;->b(Landroid/view/ViewGroup;ILjava/lang/Object;)V
    ...
    invoke-virtual {v2, v0}, Landroid/support/v4/view/bn;->b(Landroid/view/ViewGroup;)V
    ...
    .line 1185
    iput v3, v2, Landroid/support/v4/view/di;->f:I

    .line 1186
    iget-boolean v6, v2, Landroid/support/v4/view/di;->a:Z

    if-nez v6, :cond_7

    iget v6, v2, Landroid/support/v4/view/di;->c:F
    ...
    invoke-virtual {v0, v5}, Landroid/support/v4/view/ViewPager;->a(Landroid/view/View;)Landroid/support/v4/view/dh;
    ...
    .line 1190
    iget v6, v5, Landroid/support/v4/view/dh;->d:F

    iput v6, v2, Landroid/support/v4/view/di;->c:F

    .line 1191
    iget v5, v5, Landroid/support/v4/view/dh;->b:I

    iput v5, v2, Landroid/support/v4/view/di;->e:I
    ...
    iget v6, v9, Landroid/support/v4/view/dh;->d:F
    ...
    .line 1109
    :cond_b
    iget v14, v2, Landroid/support/v4/view/dh;->b:I

    if-ne v8, v14, :cond_c

    iget-boolean v14, v2, Landroid/support/v4/view/dh;->c:Z
    ...
    iget-object v14, v0, Landroid/support/v4/view/ViewPager;->h:Landroid/support/v4/view/bn;

    iget-object v2, v2, Landroid/support/v4/view/dh;->a:Ljava/lang/Object;

    move-object/from16 v0, p0

    invoke-virtual {v14, v0, v8, v2}, Landroid/support/v4/view/bn;->a(Landroid/view/ViewGroup;ILjava/lang/Object;)V
    ...
    .line 1121
    iget v2, v2, Landroid/support/v4/view/dh;->d:F
    ...
    invoke-virtual {v0, v8, v2}, Landroid/support/v4/view/ViewPager;->a(II)Landroid/support/v4/view/dh;
    ...
    .line 1143
    :cond_14
    iget v10, v2, Landroid/support/v4/view/dh;->b:I

    if-ne v8, v10, :cond_1f

    iget-boolean v10, v2, Landroid/support/v4/view/dh;->c:Z
    ...
    iget-object v10, v0, Landroid/support/v4/view/ViewPager;->h:Landroid/support/v4/view/bn;

    iget-object v2, v2, Landroid/support/v4/view/dh;->a:Ljava/lang/Object;

    move-object/from16 v0, p0

    invoke-virtual {v10, v0, v8, v2}, Landroid/support/v4/view/bn;->a(Landroid/view/ViewGroup;ILjava/lang/Object;)V
    ...
    invoke-virtual {v0, v8, v6}, Landroid/support/v4/view/ViewPager;->a(II)Landroid/support/v4/view/dh;
    ...
    invoke-virtual {v0, v2}, Landroid/support/v4/view/ViewPager;->b(Landroid/view/View;)Landroid/support/v4/view/dh;
    ...
    iget v2, v2, Landroid/support/v4/view/dh;->b:I
    ...
    invoke-virtual {v0, v3}, Landroid/support/v4/view/ViewPager;->a(Landroid/view/View;)Landroid/support/v4/view/dh;
    ...
    iget v4, v4, Landroid/support/v4/view/dh;->b:I
...
.method protected a(IFI)V
    ...
    .line 1794
    iget-boolean v9, v0, Landroid/support/v4/view/di;->a:Z
    ...
    .line 1835
    iget-object v5, p0, Landroid/support/v4/view/ViewPager;->ae:Landroid/support/v4/view/dm;

    invoke-interface {v5, v3, v0}, Landroid/support/v4/view/dm;->a(Landroid/view/View;F)V
...
.method a(III)V
    ...
    invoke-virtual {v5, v7}, Landroid/support/v4/view/bn;->b(I)F
...
.method a(IZZI)V
    ...
    iput-boolean v3, v0, Landroid/support/v4/view/dh;->c:Z
...
.method public a(Landroid/support/v4/view/dl;)V
    .locals 1
...
.method public addFocusables(Ljava/util/ArrayList;II)V
    ...
    .line 2810
    invoke-virtual {p0, v3}, Landroid/support/v4/view/ViewPager;->a(Landroid/view/View;)Landroid/support/v4/view/dh;
...
.method public addTouchables(Ljava/util/ArrayList;)V
    ...
    .line 2852
    invoke-virtual {p0, v1}, Landroid/support/v4/view/ViewPager;->a(Landroid/view/View;)Landroid/support/v4/view/dh;
...
.method public addView(Landroid/view/View;ILandroid/view/ViewGroup$LayoutParams;)V
    ...
    .line 1405
    iget-boolean v2, v0, Landroid/support/v4/view/di;->a:Z

    instance-of v3, p1, Landroid/support/v4/view/dg;

    or-int/2addr v2, v3

    iput-boolean v2, v0, Landroid/support/v4/view/di;->a:Z
    ...
    iput-boolean v2, v0, Landroid/support/v4/view/di;->d:Z
...
.method b(I)Landroid/support/v4/view/dh;
    .locals 3
...
.method b(Landroid/view/View;)Landroid/support/v4/view/dh;
    .locals 2
    ...
    .line 1452
    :cond_2
    invoke-virtual {p0, p1}, Landroid/support/v4/view/ViewPager;->a(Landroid/view/View;)Landroid/support/v4/view/dh;
...
.method b()V
    ...
    .line 965
    iget-object v7, p0, Landroid/support/v4/view/ViewPager;->h:Landroid/support/v4/view/bn;

    iget-object v9, v0, Landroid/support/v4/view/dh;->a:Ljava/lang/Object;

    invoke-virtual {v7, v9}, Landroid/support/v4/view/bn;->a(Ljava/lang/Object;)I
    ...
    .line 976
    iget-object v4, p0, Landroid/support/v4/view/ViewPager;->h:Landroid/support/v4/view/bn;

    invoke-virtual {v4, p0}, Landroid/support/v4/view/bn;->a(Landroid/view/ViewGroup;)V
    ...
    invoke-virtual {v6, p0, v7, v9}, Landroid/support/v4/view/bn;->a(Landroid/view/ViewGroup;ILjava/lang/Object;)V
    ...
    .line 991
    :cond_3
    iget v9, v0, Landroid/support/v4/view/dh;->b:I

    if-eq v9, v7, :cond_a

    .line 992
    iget v6, v0, Landroid/support/v4/view/dh;->b:I
    ...
    .line 997
    :cond_4
    iput v7, v0, Landroid/support/v4/view/dh;->b:I
    ...
    invoke-virtual {v0, p0}, Landroid/support/v4/view/bn;->b(Landroid/view/ViewGroup;)V
    ...
    .line 1014
    iget-boolean v6, v0, Landroid/support/v4/view/di;->a:Z
    ...
    iput v6, v0, Landroid/support/v4/view/di;->c:F
...
.method protected checkLayoutParams(Landroid/view/ViewGroup$LayoutParams;)Z
    ...
    .prologue
    .line 2928
    instance-of v0, p1, Landroid/support/v4/view/di;
...
.method public draw(Landroid/graphics/Canvas;)V
    ...
    invoke-virtual {v1}, Landroid/support/v4/view/bn;->b()I
    ...
    .line 2355
    iget-object v4, p0, Landroid/support/v4/view/ViewPager;->R:Landroid/support/v4/widget/s;

    invoke-virtual {v4, v2, v3}, Landroid/support/v4/widget/s;->a(II)V

    .line 2356
    iget-object v2, p0, Landroid/support/v4/view/ViewPager;->R:Landroid/support/v4/widget/s;

    invoke-virtual {v2, p1}, Landroid/support/v4/widget/s;->a(Landroid/graphics/Canvas;)Z
    ...
    .line 2366
    iget-object v4, p0, Landroid/support/v4/view/ViewPager;->S:Landroid/support/v4/widget/s;

    invoke-virtual {v4, v3, v2}, Landroid/support/v4/widget/s;->a(II)V
    ...
    invoke-virtual {v1}, Landroid/support/v4/widget/s;->b()V
...
.method e()Z
    ...
    invoke-virtual {v2}, Landroid/support/v4/view/bn;->b()I
...
.method public generateLayoutParams(Landroid/util/AttributeSet;)Landroid/view/ViewGroup$LayoutParams;
    ...
    invoke-direct {v0, v1, p1}, Landroid/support/v4/view/di;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
...
.method public getAdapter()Landroid/support/v4/view/bn;
    .locals 1
...
.method protected getChildDrawingOrder(II)I
    ...
    iget v0, v0, Landroid/support/v4/view/di;->f:I
...
.method protected onDraw(Landroid/graphics/Canvas;)V
    ...
    iget-object v1, v0, Landroid/support/v4/view/ViewPager;->h:Landroid/support/v4/view/bn;
    ...
    .line 2393
    iget v4, v1, Landroid/support/v4/view/dh;->e:F
    ...
    .line 2395
    iget v3, v1, Landroid/support/v4/view/dh;->b:I
    ...
    .line 2404
    iget v3, v1, Landroid/support/v4/view/dh;->e:F

    iget v4, v1, Landroid/support/v4/view/dh;->d:F
    ...
    iget v11, v1, Landroid/support/v4/view/dh;->d:F
    ...
    invoke-virtual {v3, v5}, Landroid/support/v4/view/bn;->b(I)F
...
.method protected onLayout(ZIIII)V
    ...
    .line 1623
    iget-boolean v7, v1, Landroid/support/v4/view/di;->a:Z

    if-eqz v7, :cond_5

    .line 1624
    iget v7, v1, Landroid/support/v4/view/di;->b:I
    ...
    .line 1676
    iget-boolean v10, v1, Landroid/support/v4/view/di;->a:Z

    if-nez v10, :cond_2

    move-object/from16 v0, p0

    invoke-virtual {v0, v8}, Landroid/support/v4/view/ViewPager;->a(Landroid/view/View;)Landroid/support/v4/view/dh;
    ...
    iget v10, v10, Landroid/support/v4/view/dh;->e:F
    ...
    .line 1680
    iget-boolean v12, v1, Landroid/support/v4/view/di;->d:Z
    ...
    iput-boolean v12, v1, Landroid/support/v4/view/di;->d:Z

    .line 1684
    int-to-float v12, v7

    iget v1, v1, Landroid/support/v4/view/di;->c:F
...
.method protected onMeasure(II)V
    ...
    iget-boolean v1, v0, Landroid/support/v4/view/di;->a:Z

    if-eqz v1, :cond_3

    .line 1500
    iget v1, v0, Landroid/support/v4/view/di;->b:I
    ...
    :cond_2
    :goto_3
    iget v4, v0, Landroid/support/v4/view/di;->width:I
    ...
    .line 1517
    iget v2, v0, Landroid/support/v4/view/di;->width:I
    ...
    .line 1521
    :goto_4
    iget v11, v0, Landroid/support/v4/view/di;->height:I
    ...
    .line 1524
    iget v0, v0, Landroid/support/v4/view/di;->height:I
    ...
    iget-boolean v5, v0, Landroid/support/v4/view/di;->a:Z
    ...
    iget v0, v0, Landroid/support/v4/view/di;->c:F
...
.method protected onRequestFocusInDescendants(ILandroid/graphics/Rect;)Z
    ...
    .line 2882
    invoke-virtual {p0, v5}, Landroid/support/v4/view/ViewPager;->a(Landroid/view/View;)Landroid/support/v4/view/dh;
    ...
    iget v6, v6, Landroid/support/v4/view/dh;->b:I
...
.method public onRestoreInstanceState(Landroid/os/Parcelable;)V
    ...
    invoke-virtual {v0, v1, v2}, Landroid/support/v4/view/bn;->a(Landroid/os/Parcelable;Ljava/lang/ClassLoader;)V
...
.method public onSaveInstanceState()Landroid/os/Parcelable;
    ...
    invoke-virtual {v0}, Landroid/support/v4/view/bn;->a()Landroid/os/Parcelable;
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    .line 2172
    iget v6, v4, Landroid/support/v4/view/dh;->b:I
    ...
    iget v3, v4, Landroid/support/v4/view/dh;->e:F

    sub-float/2addr v2, v3

    iget v3, v4, Landroid/support/v4/view/dh;->d:F
...
.method public setAdapter(Landroid/support/v4/view/bn;)V
    .locals 7
    ...
    invoke-virtual {v0, v5}, Landroid/support/v4/view/bn;->a(Landroid/database/DataSetObserver;)V

    .line 471
    iget-object v0, p0, Landroid/support/v4/view/ViewPager;->h:Landroid/support/v4/view/bn;

    invoke-virtual {v0, p0}, Landroid/support/v4/view/bn;->a(Landroid/view/ViewGroup;)V
    ...
    .line 474
    iget-object v3, p0, Landroid/support/v4/view/ViewPager;->h:Landroid/support/v4/view/bn;

    iget v4, v0, Landroid/support/v4/view/dh;->b:I

    iget-object v0, v0, Landroid/support/v4/view/dh;->a:Ljava/lang/Object;

    invoke-virtual {v3, p0, v4, v0}, Landroid/support/v4/view/bn;->a(Landroid/view/ViewGroup;ILjava/lang/Object;)V
    ...
    .line 484
    iput-object p1, p0, Landroid/support/v4/view/ViewPager;->h:Landroid/support/v4/view/bn;
    ...
    .line 488
    iget-object v1, p0, Landroid/support/v4/view/ViewPager;->o:Landroid/support/v4/view/dn;

    if-nez v1, :cond_2

    .line 489
    new-instance v1, Landroid/support/v4/view/dn;

    invoke-direct {v1, p0, v5}, Landroid/support/v4/view/dn;-><init>(Landroid/support/v4/view/ViewPager;Landroid/support/v4/view/dc;)V

    iput-object v1, p0, Landroid/support/v4/view/ViewPager;->o:Landroid/support/v4/view/dn;

    .line 491
    :cond_2
    iget-object v1, p0, Landroid/support/v4/view/ViewPager;->h:Landroid/support/v4/view/bn;

    iget-object v3, p0, Landroid/support/v4/view/ViewPager;->o:Landroid/support/v4/view/dn;

    invoke-virtual {v1, v3}, Landroid/support/v4/view/bn;->a(Landroid/database/DataSetObserver;)V
    ...
    invoke-virtual {v3}, Landroid/support/v4/view/bn;->b()I
    ...
    invoke-virtual {v1, v3, v4}, Landroid/support/v4/view/bn;->a(Landroid/os/Parcelable;Ljava/lang/ClassLoader;)V
    ...
    :cond_3
    :goto_1
    iget-object v1, p0, Landroid/support/v4/view/ViewPager;->ad:Landroid/support/v4/view/dk;
    ...
    invoke-interface {v1, v0, p1}, Landroid/support/v4/view/dk;->a(Landroid/support/v4/view/bn;Landroid/support/v4/view/bn;)V
...
.method setOnAdapterChangeListener(Landroid/support/v4/view/dk;)V
    .locals 0

    .prologue
    .line 535
    iput-object p1, p0, Landroid/support/v4/view/ViewPager;->ad:Landroid/support/v4/view/dk;

    .line 536
    return-void
.end method

.method public setOnPageChangeListener(Landroid/support/v4/view/dl;)V
    .locals 0
    ...
    .prologue
    .line 648
    iput-object p1, p0, Landroid/support/v4/view/ViewPager;->ab:Landroid/support/v4/view/dl;
