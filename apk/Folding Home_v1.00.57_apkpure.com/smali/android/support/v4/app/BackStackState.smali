...
.method public constructor <init>(Landroid/support/v4/app/i;)V
    ...
    .line 50
    iget-object v0, p1, Landroid/support/v4/app/i;->c:Landroid/support/v4/app/m;
    ...
    .line 55
    :cond_1
    iget v1, p1, Landroid/support/v4/app/i;->e:I
    ...
    .line 81
    :cond_6
    iget v0, p1, Landroid/support/v4/app/i;->j:I
    ...
    .line 83
    iget-object v0, p1, Landroid/support/v4/app/i;->n:Ljava/lang/String;
    ...
    .line 86
    iget-object v0, p1, Landroid/support/v4/app/i;->r:Ljava/lang/CharSequence;

    iput-object v0, p0, Landroid/support/v4/app/BackStackState;->g:Ljava/lang/CharSequence;

    .line 87
    iget v0, p1, Landroid/support/v4/app/i;->s:I

    iput v0, p0, Landroid/support/v4/app/BackStackState;->h:I

    .line 88
    iget-object v0, p1, Landroid/support/v4/app/i;->t:Ljava/lang/CharSequence;

    iput-object v0, p0, Landroid/support/v4/app/BackStackState;->i:Ljava/lang/CharSequence;

    .line 89
    iget-object v0, p1, Landroid/support/v4/app/i;->u:Ljava/util/ArrayList;

    iput-object v0, p0, Landroid/support/v4/app/BackStackState;->j:Ljava/util/ArrayList;

    .line 90
    iget-object v0, p1, Landroid/support/v4/app/i;->v:Ljava/util/ArrayList;
...
# virtual methods
.method public a(Landroid/support/v4/app/af;)Landroid/support/v4/app/i;
    .locals 11
    ...
    invoke-direct {v6, p1}, Landroid/support/v4/app/i;-><init>(Landroid/support/v4/app/af;)V
    ...
    .line 118
    iget-object v4, p1, Landroid/support/v4/app/af;->f:Ljava/util/ArrayList;
    ...
    .line 133
    :cond_1
    iget-object v0, p1, Landroid/support/v4/app/af;->f:Ljava/util/ArrayList;
    ...
    .line 137
    :cond_3
    iget v0, v7, Landroid/support/v4/app/m;->e:I

    iput v0, v6, Landroid/support/v4/app/i;->f:I

    .line 138
    iget v0, v7, Landroid/support/v4/app/m;->f:I

    iput v0, v6, Landroid/support/v4/app/i;->g:I

    .line 139
    iget v0, v7, Landroid/support/v4/app/m;->g:I

    iput v0, v6, Landroid/support/v4/app/i;->h:I

    .line 140
    iget v0, v7, Landroid/support/v4/app/m;->h:I

    iput v0, v6, Landroid/support/v4/app/i;->i:I

    .line 141
    invoke-virtual {v6, v7}, Landroid/support/v4/app/i;->a(Landroid/support/v4/app/m;)V
    ...
    iput v0, v6, Landroid/support/v4/app/i;->k:I

    .line 146
    iget-object v0, p0, Landroid/support/v4/app/BackStackState;->d:Ljava/lang/String;

    iput-object v0, v6, Landroid/support/v4/app/i;->n:Ljava/lang/String;
