...
# static fields
.field private static d:Landroid/support/v7/a/bc;
...
.method static a()Landroid/support/v7/a/bc;
    .locals 1

    .prologue
    .line 31
    sget-object v0, Landroid/support/v7/a/bc;->d:Landroid/support/v7/a/bc;
    ...
    invoke-direct {v0}, Landroid/support/v7/a/bc;-><init>()V

    sput-object v0, Landroid/support/v7/a/bc;->d:Landroid/support/v7/a/bc;
...
.method public a(JDD)V
    ...
    iput v2, p0, Landroid/support/v7/a/bc;->c:I

    .line 115
    const-wide/16 v2, -0x1

    iput-wide v2, p0, Landroid/support/v7/a/bc;->a:J

    .line 116
    const-wide/16 v2, -0x1

    iput-wide v2, p0, Landroid/support/v7/a/bc;->b:J
    ...
    iput-wide v6, p0, Landroid/support/v7/a/bc;->a:J
    ...
    .line 130
    iget-wide v2, p0, Landroid/support/v7/a/bc;->b:J

    cmp-long v2, v2, p1

    if-gez v2, :cond_2

    iget-wide v2, p0, Landroid/support/v7/a/bc;->a:J
