...
# instance fields
.field private a:Landroid/support/v7/widget/by;
...
.field private final i:Landroid/support/v7/widget/gi;
...
.method public constructor <init>(Landroid/support/v7/widget/Toolbar;Ljava/lang/CharSequence;Landroid/view/Window$Callback;)V
    ...
    iput-object v0, p0, Landroid/support/v7/a/av;->i:Landroid/support/v7/widget/gi;
    ...
    invoke-direct {v0, p1, v1}, Landroid/support/v7/widget/gk;-><init>(Landroid/support/v7/widget/Toolbar;Z)V

    iput-object v0, p0, Landroid/support/v7/a/av;->a:Landroid/support/v7/widget/by;
    ...
    .line 76
    iget-object v0, p0, Landroid/support/v7/a/av;->a:Landroid/support/v7/widget/by;

    iget-object v1, p0, Landroid/support/v7/a/av;->c:Landroid/view/Window$Callback;

    invoke-interface {v0, v1}, Landroid/support/v7/widget/by;->a(Landroid/view/Window$Callback;)V

    .line 77
    iget-object v0, p0, Landroid/support/v7/a/av;->i:Landroid/support/v7/widget/gi;

    invoke-virtual {p1, v0}, Landroid/support/v7/widget/Toolbar;->setOnMenuItemClickListener(Landroid/support/v7/widget/gi;)V

    .line 78
    iget-object v0, p0, Landroid/support/v7/a/av;->a:Landroid/support/v7/widget/by;

    invoke-interface {v0, p2}, Landroid/support/v7/widget/by;->a(Ljava/lang/CharSequence;)V
...
.method private a(Landroid/view/Menu;)Landroid/view/View;
    ...
    iget-object v1, p0, Landroid/support/v7/a/av;->a:Landroid/support/v7/widget/by;

    invoke-interface {v1}, Landroid/support/v7/widget/by;->a()Landroid/view/ViewGroup;
...
.method static synthetic c(Landroid/support/v7/a/av;)Landroid/support/v7/widget/by;
    .locals 1
...
.method private k()Landroid/view/Menu;
    ...
    invoke-interface {v0, v1, v2}, Landroid/support/v7/widget/by;->a(Landroid/support/v7/view/menu/y;Landroid/support/v7/view/menu/j;)V
...
.method public a(I)V
    ...
    :goto_0
    invoke-interface {v1, v0}, Landroid/support/v7/widget/by;->b(Ljava/lang/CharSequence;)V
...
.method public b()Z
    ...
    invoke-interface {v0}, Landroid/support/v7/widget/by;->q()I
