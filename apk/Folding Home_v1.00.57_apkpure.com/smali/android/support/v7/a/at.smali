...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/support/v7/a/at;->a:[Ljava/lang/Class;
    ...
    sput-object v0, Landroid/support/v7/a/at;->b:[I
    ...
    sput-object v0, Landroid/support/v7/a/at;->c:[Ljava/lang/String;
    ...
    sput-object v0, Landroid/support/v7/a/at;->d:Ljava/util/Map;
...
.method constructor <init>()V
    ...
    iput-object v0, p0, Landroid/support/v7/a/at;->e:[Ljava/lang/Object;
...
.method private a(Landroid/content/Context;Ljava/lang/String;Landroid/util/AttributeSet;)Landroid/view/View;
    ...
    :cond_0
    :try_start_0
    iget-object v0, p0, Landroid/support/v7/a/at;->e:[Ljava/lang/Object;
    ...
    .line 167
    :goto_0
    sget-object v0, Landroid/support/v7/a/at;->c:[Ljava/lang/String;
    ...
    invoke-direct {p0, p1, p2, v0}, Landroid/support/v7/a/at;->a(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)Landroid/view/View;
    :try_end_0
    ...
    .line 183
    iget-object v2, p0, Landroid/support/v7/a/at;->e:[Ljava/lang/Object;
...
.method private a(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)Landroid/view/View;
    ...
    .prologue
    .line 214
    sget-object v0, Landroid/support/v7/a/at;->d:Ljava/util/Map;
    ...
    .line 222
    sget-object v1, Landroid/support/v7/a/at;->a:[Ljava/lang/Class;
    ...
    .line 223
    sget-object v1, Landroid/support/v7/a/at;->d:Ljava/util/Map;
    ...
    .line 226
    iget-object v1, p0, Landroid/support/v7/a/at;->e:[Ljava/lang/Object;
...
.method private a(Landroid/view/View;Landroid/util/AttributeSet;)V
    ...
    invoke-static {p1}, Landroid/support/v4/view/bv;->D(Landroid/view/View;)Z
    ...
    .line 204
    :cond_1
    sget-object v1, Landroid/support/v7/a/at;->b:[I
    ...
    .line 207
    new-instance v2, Landroid/support/v7/a/au;

    invoke-direct {v2, p1, v1}, Landroid/support/v7/a/au;-><init>(Landroid/view/View;Ljava/lang/String;)V
...
.method public final a(Landroid/view/View;Ljava/lang/String;Landroid/content/Context;Landroid/util/AttributeSet;ZZZZ)Landroid/view/View;
    ...
    .line 92
    :cond_0
    invoke-static {v0, p4, p6, p7}, Landroid/support/v7/a/at;->a(Landroid/content/Context;Landroid/util/AttributeSet;ZZ)Landroid/content/Context;
    ...
    .line 95
    invoke-static {v0}, Landroid/support/v7/widget/fz;->a(Landroid/content/Context;)Landroid/content/Context;
    ...
    .line 146
    invoke-direct {p0, v0, p2, p4}, Landroid/support/v7/a/at;->a(Landroid/content/Context;Ljava/lang/String;Landroid/util/AttributeSet;)Landroid/view/View;
    ...
    .line 151
    invoke-direct {p0, v0, p4}, Landroid/support/v7/a/at;->a(Landroid/view/View;Landroid/util/AttributeSet;)V
    ...
    invoke-direct {v1, v0, p4}, Landroid/support/v7/widget/bs;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    invoke-direct {v1, v0, p4}, Landroid/support/v7/widget/bj;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    invoke-direct {v1, v0, p4}, Landroid/support/v7/widget/bh;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
