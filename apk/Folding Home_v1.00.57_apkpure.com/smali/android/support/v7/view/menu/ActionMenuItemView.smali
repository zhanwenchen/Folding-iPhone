...
.field private e:Landroid/support/v7/widget/dd;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    .line 72
    invoke-direct {p0, p1, p2, p3}, Landroid/support/v7/widget/bs;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
...
.method public a(Landroid/support/v7/view/menu/m;I)V
    ...
    .line 121
    iget-object v0, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->e:Landroid/support/v7/widget/dd;
    ...
    iput-object v0, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->e:Landroid/support/v7/widget/dd;
...
.method public onConfigurationChanged(Landroid/content/res/Configuration;)V
    ...
    .line 93
    invoke-super {p0, p1}, Landroid/support/v7/widget/bs;->onConfigurationChanged(Landroid/content/res/Configuration;)V
...
.method protected onMeasure(II)V
    ...
    invoke-super {p0, v0, v2, v3, v4}, Landroid/support/v7/widget/bs;->setPadding(IIII)V

    .line 271
    :cond_0
    invoke-super {p0, p1, p2}, Landroid/support/v7/widget/bs;->onMeasure(II)V
    ...
    invoke-super {p0, v0, p2}, Landroid/support/v7/widget/bs;->onMeasure(II)V
    ...
    invoke-super {p0, v0, v1, v2, v3}, Landroid/support/v7/widget/bs;->setPadding(IIII)V
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    invoke-virtual {v0, p0, p1}, Landroid/support/v7/widget/dd;->onTouch(Landroid/view/View;Landroid/view/MotionEvent;)Z
    ...
    :cond_0
    invoke-super {p0, p1}, Landroid/support/v7/widget/bs;->onTouchEvent(Landroid/view/MotionEvent;)Z
...
.method public setPadding(IIII)V
    ...
    .line 104
    invoke-super {p0, p1, p2, p3, p4}, Landroid/support/v7/widget/bs;->setPadding(IIII)V
