...
.field private c:Landroid/support/v7/a/s;
...
.method public a()V
    ...
    .prologue
    .line 137
    iget-object v0, p0, Landroid/support/v7/view/menu/l;->c:Landroid/support/v7/a/s;
    ...
    invoke-virtual {v0}, Landroid/support/v7/a/s;->dismiss()V
...
.method public a(Landroid/os/IBinder;)V
    ...
    invoke-direct {v1, v2}, Landroid/support/v7/a/t;-><init>(Landroid/content/Context;)V

    .line 57
    new-instance v2, Landroid/support/v7/view/menu/g;

    invoke-virtual {v1}, Landroid/support/v7/a/t;->a()Landroid/content/Context;
    ...
    invoke-virtual {v1, v2, p0}, Landroid/support/v7/a/t;->a(Landroid/widget/ListAdapter;Landroid/content/DialogInterface$OnClickListener;)Landroid/support/v7/a/t;
    ...
    .line 68
    invoke-virtual {v1, v2}, Landroid/support/v7/a/t;->a(Landroid/view/View;)Landroid/support/v7/a/t;

    .line 75
    :goto_0
    invoke-virtual {v1, p0}, Landroid/support/v7/a/t;->a(Landroid/content/DialogInterface$OnKeyListener;)Landroid/support/v7/a/t;

    .line 78
    invoke-virtual {v1}, Landroid/support/v7/a/t;->b()Landroid/support/v7/a/s;

    move-result-object v0

    iput-object v0, p0, Landroid/support/v7/view/menu/l;->c:Landroid/support/v7/a/s;

    .line 79
    iget-object v0, p0, Landroid/support/v7/view/menu/l;->c:Landroid/support/v7/a/s;

    invoke-virtual {v0, p0}, Landroid/support/v7/a/s;->setOnDismissListener(Landroid/content/DialogInterface$OnDismissListener;)V

    .line 81
    iget-object v0, p0, Landroid/support/v7/view/menu/l;->c:Landroid/support/v7/a/s;

    invoke-virtual {v0}, Landroid/support/v7/a/s;->getWindow()Landroid/view/Window;
    ...
    invoke-virtual {v1, v2}, Landroid/support/v7/a/t;->a(Landroid/graphics/drawable/Drawable;)Landroid/support/v7/a/t;
    ...
    invoke-virtual {v2, v0}, Landroid/support/v7/a/t;->a(Ljava/lang/CharSequence;)Landroid/support/v7/a/t;
...
.method public onKey(Landroid/content/DialogInterface;ILandroid/view/KeyEvent;)Z
    ...
    .line 95
    iget-object v1, p0, Landroid/support/v7/view/menu/l;->c:Landroid/support/v7/a/s;

    invoke-virtual {v1}, Landroid/support/v7/a/s;->getWindow()Landroid/view/Window;
