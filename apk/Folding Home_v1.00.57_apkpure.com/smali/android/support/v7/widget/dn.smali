...
# instance fields
.field final a:Landroid/support/v7/widget/do;
...
.method public constructor <init>(Landroid/support/v7/widget/do;)V
    ...
    .line 32
    iput-object p1, p0, Landroid/support/v7/widget/dn;->a:Landroid/support/v7/widget/do;
...
.method private a(Ljava/util/List;II)V
    ...
    .line 49
    invoke-virtual/range {v0 .. v5}, Landroid/support/v7/widget/dn;->a(Ljava/util/List;ILandroid/support/v7/widget/ak;ILandroid/support/v7/widget/ak;)V
    ...
    .line 52
    invoke-direct/range {v0 .. v5}, Landroid/support/v7/widget/dn;->c(Ljava/util/List;ILandroid/support/v7/widget/ak;ILandroid/support/v7/widget/ak;)V
    ...
    .line 55
    invoke-virtual/range {v0 .. v5}, Landroid/support/v7/widget/dn;->b(Ljava/util/List;ILandroid/support/v7/widget/ak;ILandroid/support/v7/widget/ak;)V
...
.method a(Ljava/util/List;)V
    ...
    .line 39
    :goto_0
    invoke-direct {p0, p1}, Landroid/support/v7/widget/dn;->b(Ljava/util/List;)I
    ...
    invoke-direct {p0, p1, v0, v1}, Landroid/support/v7/widget/dn;->a(Ljava/util/List;II)V
...
.method a(Ljava/util/List;ILandroid/support/v7/widget/ak;ILandroid/support/v7/widget/ak;)V
    ...
    .line 111
    iget-object v0, p0, Landroid/support/v7/widget/dn;->a:Landroid/support/v7/widget/do;

    invoke-interface {v0, p3}, Landroid/support/v7/widget/do;->a(Landroid/support/v7/widget/ak;)V
    ...
    invoke-interface {v0, p5}, Landroid/support/v7/widget/do;->a(Landroid/support/v7/widget/ak;)V
    ...
    .line 103
    iget-object v4, p0, Landroid/support/v7/widget/dn;->a:Landroid/support/v7/widget/do;

    iget v5, p3, Landroid/support/v7/widget/ak;->b:I

    add-int/lit8 v5, v5, 0x1

    invoke-interface {v4, v7, v5, v1, v3}, Landroid/support/v7/widget/do;->a(IIILjava/lang/Object;)Landroid/support/v7/widget/ak;
...
.method b(Ljava/util/List;ILandroid/support/v7/widget/ak;ILandroid/support/v7/widget/ak;)V
    ...
    invoke-interface {v0, v5, v2, v3, v4}, Landroid/support/v7/widget/do;->a(IIILjava/lang/Object;)Landroid/support/v7/widget/ak;
    ...
    .line 198
    iget-object v1, p0, Landroid/support/v7/widget/dn;->a:Landroid/support/v7/widget/do;
    ...
    invoke-interface {v1, v5, v3, v2, v4}, Landroid/support/v7/widget/do;->a(IIILjava/lang/Object;)Landroid/support/v7/widget/ak;
    ...
    .line 207
    iget-object v2, p0, Landroid/support/v7/widget/dn;->a:Landroid/support/v7/widget/do;

    invoke-interface {v2, p5}, Landroid/support/v7/widget/do;->a(Landroid/support/v7/widget/ak;)V
