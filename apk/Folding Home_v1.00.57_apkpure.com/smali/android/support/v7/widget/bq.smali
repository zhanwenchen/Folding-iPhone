...
.method protected static a(Landroid/content/Context;Landroid/support/v7/widget/ar;I)Landroid/support/v7/widget/ga;
    .locals 3
...
.method a()V
    ...
    .prologue
    .line 130
    iget-object v0, p0, Landroid/support/v7/widget/bq;->d:Landroid/support/v7/widget/ga;

    if-nez v0, :cond_0

    iget-object v0, p0, Landroid/support/v7/widget/bq;->e:Landroid/support/v7/widget/ga;

    if-nez v0, :cond_0

    iget-object v0, p0, Landroid/support/v7/widget/bq;->f:Landroid/support/v7/widget/ga;

    if-nez v0, :cond_0

    iget-object v0, p0, Landroid/support/v7/widget/bq;->g:Landroid/support/v7/widget/ga;
    ...
    iget-object v2, p0, Landroid/support/v7/widget/bq;->d:Landroid/support/v7/widget/ga;

    invoke-virtual {p0, v1, v2}, Landroid/support/v7/widget/bq;->a(Landroid/graphics/drawable/Drawable;Landroid/support/v7/widget/ga;)V
    ...
    iget-object v2, p0, Landroid/support/v7/widget/bq;->e:Landroid/support/v7/widget/ga;
    ...
    iget-object v2, p0, Landroid/support/v7/widget/bq;->f:Landroid/support/v7/widget/ga;
    ...
    iget-object v1, p0, Landroid/support/v7/widget/bq;->g:Landroid/support/v7/widget/ga;

    invoke-virtual {p0, v0, v1}, Landroid/support/v7/widget/bq;->a(Landroid/graphics/drawable/Drawable;Landroid/support/v7/widget/ga;)V
...
.method final a(Landroid/graphics/drawable/Drawable;Landroid/support/v7/widget/ga;)V
    ...
    invoke-static {p1, p2, v0}, Landroid/support/v7/widget/ar;->a(Landroid/graphics/drawable/Drawable;Landroid/support/v7/widget/ga;[I)V
...
.method a(Landroid/util/AttributeSet;I)V
    ...
    invoke-static {v4, v0, v6}, Landroid/support/v7/widget/bq;->a(Landroid/content/Context;Landroid/support/v7/widget/ar;I)Landroid/support/v7/widget/ga;

    move-result-object v6

    iput-object v6, p0, Landroid/support/v7/widget/bq;->d:Landroid/support/v7/widget/ga;
    ...
    iput-object v6, p0, Landroid/support/v7/widget/bq;->e:Landroid/support/v7/widget/ga;
    ...
    iput-object v6, p0, Landroid/support/v7/widget/bq;->f:Landroid/support/v7/widget/ga;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/bq;->g:Landroid/support/v7/widget/ga;
