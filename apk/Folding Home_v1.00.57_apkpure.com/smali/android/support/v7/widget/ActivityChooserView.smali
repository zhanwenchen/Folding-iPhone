...
.field private final d:Landroid/support/v7/widget/cs;
...
.method private a(I)V
    ...
    .line 366
    :goto_2
    invoke-direct {p0}, Landroid/support/v7/widget/ActivityChooserView;->getListPopupWindow()Landroid/support/v7/widget/cy;
    ...
    .line 374
    invoke-virtual {v3, v0}, Landroid/support/v7/widget/cy;->f(I)V

    .line 375
    invoke-virtual {v3}, Landroid/support/v7/widget/cy;->c()V
    ...
    .line 379
    :cond_2
    invoke-virtual {v3}, Landroid/support/v7/widget/cy;->m()Landroid/widget/ListView;
...
.method private getListPopupWindow()Landroid/support/v7/widget/cy;
    .locals 2

    .prologue
    .line 503
    iget-object v0, p0, Landroid/support/v7/widget/ActivityChooserView;->k:Landroid/support/v7/widget/cy;
    ...
    invoke-direct {v0, v1}, Landroid/support/v7/widget/cy;-><init>(Landroid/content/Context;)V

    iput-object v0, p0, Landroid/support/v7/widget/ActivityChooserView;->k:Landroid/support/v7/widget/cy;
    ...
    invoke-virtual {v0, v1}, Landroid/support/v7/widget/cy;->a(Landroid/widget/ListAdapter;)V

    .line 506
    iget-object v0, p0, Landroid/support/v7/widget/ActivityChooserView;->k:Landroid/support/v7/widget/cy;

    invoke-virtual {v0, p0}, Landroid/support/v7/widget/cy;->a(Landroid/view/View;)V
    ...
    invoke-virtual {v0, v1}, Landroid/support/v7/widget/cy;->a(Z)V
    ...
    invoke-virtual {v0, v1}, Landroid/support/v7/widget/cy;->a(Landroid/widget/AdapterView$OnItemClickListener;)V
    ...
    invoke-virtual {v0, v1}, Landroid/support/v7/widget/cy;->a(Landroid/widget/PopupWindow$OnDismissListener;)V
...
.method protected onLayout(ZIIII)V
    ...
    .line 452
    iget-object v0, p0, Landroid/support/v7/widget/ActivityChooserView;->d:Landroid/support/v7/widget/cs;

    sub-int v1, p4, p2

    sub-int v2, p5, p3

    invoke-virtual {v0, v3, v3, v1, v2}, Landroid/support/v7/widget/cs;->layout(IIII)V
