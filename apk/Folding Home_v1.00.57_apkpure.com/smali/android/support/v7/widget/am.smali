...
.method private b(Landroid/graphics/drawable/Drawable;)Z
    ...
    .line 150
    iget-object v1, p0, Landroid/support/v7/widget/am;->e:Landroid/support/v7/widget/ga;
    ...
    invoke-direct {v1}, Landroid/support/v7/widget/ga;-><init>()V

    iput-object v1, p0, Landroid/support/v7/widget/am;->e:Landroid/support/v7/widget/ga;
    ...
    invoke-static {v2}, Landroid/support/v4/view/bv;->x(Landroid/view/View;)Landroid/content/res/ColorStateList;
    ...
    .line 158
    iput-boolean v0, v1, Landroid/support/v7/widget/ga;->d:Z

    .line 159
    iput-object v2, v1, Landroid/support/v7/widget/ga;->a:Landroid/content/res/ColorStateList;

    .line 161
    :cond_1
    iget-object v2, p0, Landroid/support/v7/widget/am;->a:Landroid/view/View;

    invoke-static {v2}, Landroid/support/v4/view/bv;->y(Landroid/view/View;)Landroid/graphics/PorterDuff$Mode;
    ...
    .line 163
    iput-boolean v0, v1, Landroid/support/v7/widget/ga;->c:Z

    .line 164
    iput-object v2, v1, Landroid/support/v7/widget/ga;->b:Landroid/graphics/PorterDuff$Mode;

    .line 167
    :cond_2
    iget-boolean v2, v1, Landroid/support/v7/widget/ga;->d:Z

    if-nez v2, :cond_3

    iget-boolean v2, v1, Landroid/support/v7/widget/ga;->c:Z
    ...
    invoke-static {p1, v1, v2}, Landroid/support/v7/widget/ar;->a(Landroid/graphics/drawable/Drawable;Landroid/support/v7/widget/ga;[I)V
...
.method a()Landroid/content/res/ColorStateList;
    ...
    .prologue
    .line 93
    iget-object v0, p0, Landroid/support/v7/widget/am;->d:Landroid/support/v7/widget/ga;
...
.method a(Landroid/content/res/ColorStateList;)V
    ...
    iput-object v0, p0, Landroid/support/v7/widget/am;->d:Landroid/support/v7/widget/ga;
...
.method a(Landroid/util/AttributeSet;I)V
    ...
    invoke-static {v0, v2}, Landroid/support/v4/view/bv;->a(Landroid/view/View;Landroid/content/res/ColorStateList;)V
    ...
    invoke-static {v2, v3}, Landroid/support/v7/widget/cl;->a(ILandroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuff$Mode;

    move-result-object v2

    invoke-static {v0, v2}, Landroid/support/v4/view/bv;->a(Landroid/view/View;Landroid/graphics/PorterDuff$Mode;)V
    :try_end_0
...
.method b(Landroid/content/res/ColorStateList;)V
    ...
    .line 133
    iget-object v0, p0, Landroid/support/v7/widget/am;->c:Landroid/support/v7/widget/ga;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/am;->c:Landroid/support/v7/widget/ga;
...
.method c()V
    ...
    .line 121
    :cond_1
    iget-object v1, p0, Landroid/support/v7/widget/am;->d:Landroid/support/v7/widget/ga;
    ...
    invoke-static {v0, v1, v2}, Landroid/support/v7/widget/ar;->a(Landroid/graphics/drawable/Drawable;Landroid/support/v7/widget/ga;[I)V

    goto :goto_0

    .line 124
    :cond_2
    iget-object v1, p0, Landroid/support/v7/widget/am;->c:Landroid/support/v7/widget/ga;
