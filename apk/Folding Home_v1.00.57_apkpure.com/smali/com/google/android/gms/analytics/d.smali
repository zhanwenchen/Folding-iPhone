...
.method private a()V
    ...
    :try_start_0
    sget-object v1, Lcom/google/android/gms/analytics/c;->a:Ljava/lang/Object;
    ...
    :try_start_1
    sget-object v0, Lcom/google/android/gms/analytics/c;->b:Lcom/google/android/gms/c/cx;

    if-eqz v0, :cond_0

    invoke-virtual {v0}, Lcom/google/android/gms/c/cx;->b()Z

    move-result v2

    if-eqz v2, :cond_0

    invoke-virtual {v0}, Lcom/google/android/gms/c/cx;->a()V
...
.method public static a(Landroid/content/Context;)Z
    ...
    sget-object v0, Lcom/google/android/gms/analytics/d;->b:Ljava/lang/Boolean;
    ...
    sput-object v1, Lcom/google/android/gms/analytics/d;->b:Ljava/lang/Boolean;
...
.method private b()Landroid/os/Handler;
    ...
    iget-object v0, p0, Lcom/google/android/gms/analytics/d;->a:Landroid/os/Handler;

    if-nez v0, :cond_0

    new-instance v0, Landroid/os/Handler;

    invoke-virtual {p0}, Lcom/google/android/gms/analytics/d;->getMainLooper()Landroid/os/Looper;

    move-result-object v1

    invoke-direct {v0, v1}, Landroid/os/Handler;-><init>(Landroid/os/Looper;)V

    iput-object v0, p0, Lcom/google/android/gms/analytics/d;->a:Landroid/os/Handler;
...
.method protected a(Lcom/google/android/gms/analytics/internal/j;Landroid/os/Handler;I)V
    ...
    invoke-direct {v0, p0, p3, p1}, Lcom/google/android/gms/analytics/g;-><init>(Lcom/google/android/gms/analytics/d;ILcom/google/android/gms/analytics/internal/j;)V
...
.method public onStartCommand(Landroid/content/Intent;II)I
    ...
    invoke-direct {p0}, Lcom/google/android/gms/analytics/d;->a()V

    invoke-static {p0}, Lcom/google/android/gms/analytics/internal/ad;->a(Landroid/content/Context;)Lcom/google/android/gms/analytics/internal/ad;

    move-result-object v1

    invoke-virtual {v1}, Lcom/google/android/gms/analytics/internal/ad;->f()Lcom/google/android/gms/analytics/internal/j;

    move-result-object v2

    const/4 v0, 0x0

    invoke-virtual {v1}, Lcom/google/android/gms/analytics/internal/ad;->e()Lcom/google/android/gms/analytics/internal/bd;

    move-result-object v3

    invoke-virtual {v3}, Lcom/google/android/gms/analytics/internal/bd;->a()Z
    ...
    :goto_0
    invoke-direct {p0}, Lcom/google/android/gms/analytics/d;->b()Landroid/os/Handler;
    ...
    :cond_0
    invoke-virtual {v1}, Lcom/google/android/gms/analytics/internal/ad;->h()Lcom/google/android/gms/d/g;

    move-result-object v0

    new-instance v1, Lcom/google/android/gms/analytics/e;

    invoke-direct {v1, p0, v2, v3, p3}, Lcom/google/android/gms/analytics/e;-><init>(Lcom/google/android/gms/analytics/d;Lcom/google/android/gms/analytics/internal/j;Landroid/os/Handler;I)V
    ...
    invoke-virtual {v4}, Lcom/google/android/gms/analytics/internal/bd;->e()I
    ...
    invoke-virtual {v1}, Lcom/google/android/gms/analytics/internal/ad;->i()Lcom/google/android/gms/analytics/internal/t;

    move-result-object v1

    new-instance v4, Lcom/google/android/gms/analytics/f;

    invoke-direct {v4, p0, v2, v3, p3}, Lcom/google/android/gms/analytics/f;-><init>(Lcom/google/android/gms/analytics/d;Lcom/google/android/gms/analytics/internal/j;Landroid/os/Handler;I)V
