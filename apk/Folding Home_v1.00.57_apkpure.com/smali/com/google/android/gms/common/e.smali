...
.method public static a(ILandroid/app/Activity;I)Landroid/app/Dialog;
    ...
    invoke-static {p0, p1, p2, v0}, Lcom/google/android/gms/common/e;->a(ILandroid/app/Activity;ILandroid/content/DialogInterface$OnCancelListener;)Landroid/app/Dialog;
...
.method public static a(ILandroid/app/Activity;ILandroid/content/DialogInterface$OnCancelListener;)Landroid/app/Dialog;
    ...
    invoke-static {p0, p1, v0, p2, p3}, Lcom/google/android/gms/common/e;->b(ILandroid/app/Activity;Landroid/support/v4/app/Fragment;ILandroid/content/DialogInterface$OnCancelListener;)Landroid/app/Dialog;
...
.method public static a(Landroid/app/Activity;Landroid/content/DialogInterface$OnCancelListener;Ljava/lang/String;Landroid/app/Dialog;)V
    ...
    invoke-virtual {v1, v0, p2}, Lcom/google/android/gms/common/f;->a(Landroid/support/v4/app/ad;Ljava/lang/String;)V
...
.method public static a(Landroid/content/Context;I)Z
    ...
    invoke-static {p0, p1}, Lcom/google/android/gms/common/r;->c(Landroid/content/Context;I)Z
...
.method private static b(ILandroid/app/Activity;Landroid/support/v4/app/Fragment;ILandroid/content/DialogInterface$OnCancelListener;)Landroid/app/Dialog;
    ...
    :cond_0
    invoke-static {p1}, Lcom/google/android/gms/c/bi;->a(Landroid/content/Context;)Z
    ...
    :cond_1
    invoke-static {p1, p0}, Lcom/google/android/gms/common/e;->a(Landroid/content/Context;I)Z
    ...
    :cond_4
    invoke-static {p1}, Lcom/google/android/gms/common/e;->c(Landroid/content/Context;)Ljava/lang/String;

    move-result-object v1

    invoke-static {p1, p0, v1}, Lcom/google/android/gms/common/internal/w;->a(Landroid/content/Context;ILjava/lang/String;)Ljava/lang/String;
    ...
    invoke-direct {v1, p1, v2, p3}, Lcom/google/android/gms/common/internal/x;-><init>(Landroid/app/Activity;Landroid/content/Intent;I)V

    :goto_1
    invoke-static {p1, p0}, Lcom/google/android/gms/common/internal/w;->b(Landroid/content/Context;I)Ljava/lang/String;
    ...
    :cond_6
    invoke-static {p1, p0}, Lcom/google/android/gms/common/internal/w;->a(Landroid/content/Context;I)Ljava/lang/String;
    ...
    invoke-direct {v1, p2, v2, p3}, Lcom/google/android/gms/common/internal/x;-><init>(Landroid/support/v4/app/Fragment;Landroid/content/Intent;I)V
